...
/*   Updated: 2026/01/15 09:41:59 by yroard           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace webserv {
	namespace http {
		...
		private:
            ...
            static std::string parseLineRequest(std::string* rawHeader, const std::string& s, tExceptError error);
            static std::string parseForQueryLineRequest(std::string *fullUri);
            static std::string trimHeader(const std::string& str);
            static std::map<std::string, std::string> parseForHeaderLineRequest(std::string &rawHeader);
		...
		public:
            ...
            std::string getHeaderInfo(const std::string& ToFind);
